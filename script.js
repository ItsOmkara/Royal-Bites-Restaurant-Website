...
window.onscroll = function() {
    ...
    if (window.pageYOffset > headerSection.offsetHeight - 75) {
        ...
        // logoImage.src = "https://hellomangaluru.online/media/2022/01/WhatsApp-Image-2022-01-19-at-3.46.49-PM.jpeg";
    } else {
    ...
    // home page JS
    if (pageTitle.text === "Royal Bites- Restaurant") {
...
document.querySelector('.svg-down').addEventListener('click', function() {
    window.scrollBy({
